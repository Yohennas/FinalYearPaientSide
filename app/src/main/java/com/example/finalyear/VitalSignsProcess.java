...
import com.example.finalyear.Math.Fft;
import com.example.finalyear.Math.Fft2;
...
public class VitalSignsProcess extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String gen = null;
        try {
            Hei = Integer.parseInt(dataBase.stringValue("height"));
            Wei = Integer.parseInt(dataBase.stringValue("weight"));
            Agg = Integer.parseInt(dataBase.stringValue("age"));
            gen = dataBase.stringValue("sex").trim();
